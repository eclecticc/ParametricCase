...
module back_to_back() {
    ...
    translate([miniitx_pci_e_offset[0], miniitx_pci_e_offset[1]+100, -40]) {
...
module traditional_tower_cooler() {
    ...
    translate([miniitx_pci_e_offset[0], miniitx_pci_e_offset[1], miniitx_pci_e_offset[2]+miniitx[2]]) {
        zotac_1080_mini();
    }
}
